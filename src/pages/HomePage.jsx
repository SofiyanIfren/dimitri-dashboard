        ...
        <main className="grow">
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="grid grid-cols-12 gap-6">
              ...
              {/* Line chart (Total Stamps) */}
              <TotalStampsDashboardCard />
              {/* Line chart (Active customers) */}
              <ActiveCustomersDashboardCard />
              {/* Line chart (New customers) */}
              <NewCustomersDashboardCard />
              {/* Doughnut chart (Total rewards) */}
              <GivenRewardsDashboardCard />
              {/* Table (Top Rewards) */}
              <TopRewardsDashboardCard />
