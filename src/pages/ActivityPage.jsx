...
import StampsActivityDashboardCard from '../partials/dashboard/StampsActivityDashboardCard';
        ...
        <main className="grow">
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="grid grid-cols-12 gap-6">
              ...
              <UsersActivityDashboardCard />
              {/* Card (Stamps Activity) */}
              <StampsActivityDashboardCard />
